...
Editar el módulo correspondiente en js/.
Verificar sintaxis de todos los módulos: for f in js/*.js; do node --check "$f"; done.
Subir VERSION en service-worker.js y actualizar las referencias ?v=NN de index.html.
Publicar en main (GitHub Pages). La app tomará la nueva versión al recargar.
Empresa
